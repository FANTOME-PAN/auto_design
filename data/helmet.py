...
class HelmetAnnotationTransform(object):
    """Transforms a Helmet annotation into a Tensor of bbox coords and label index
    ...
    def __init__(self, class_to_ind=None, keep_difficult=False):
        self.class_to_ind = class_to_ind or dict(
            zip(HELMET_CLASSES, range(len(HELMET_CLASSES))))
        self.class_to_ind['helmet-on'] = self.class_to_ind['helmet_on']
        self.class_to_ind['helmet-off'] = self.class_to_ind['helmet_off']
