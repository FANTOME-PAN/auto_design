...
def test_net(save_folder, net, cuda, dataset, transform, top_k,
    ...
    for i in range(num_images):
        ...
        if args.write_imgs:
            ...
            output_detection_result(_imgpath, dataset.ids[i], detections, h, w, classes=labelmap, score_thresh=0.7,
                                    out_dir='./eval/%s/bignet_output' % args.dataset, annopath=_annopath, show=False)
